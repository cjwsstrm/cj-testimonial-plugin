...
class Cj_Testimonial_Plugin_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/cj-testimonial-plugin-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/cj-testimonial-plugin-admin.js', array( 'jquery' ), $this->version, false );
